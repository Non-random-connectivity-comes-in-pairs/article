...
$\alpha \geq 1$ as shown in Figure~\ref{fig:gd}C. \cc{[Felix: you asked me to use $\varrho$ in the equation above, but it's an approximation so don't want to do that. I introduced $\tilde{\varrho}$ instead, I don't know if that makes it better]}
