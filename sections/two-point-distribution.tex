...
and $1-p$ respectively (Figure~\ref{fig:tp}A) \cc{[Felix: I guess we could add it here?]}. %
%
...
%
\cc{[Felix: You said: \enquote{you must also refer to Figure 1A in the text and do so before you mention Figure 1B.} Really? Let's wait and see if it's a problem, or is it really important to you that we talk about Figure 1A in the text as well? I added it to the first sentence for now, but still would prefer not to. It's an illustration of the concept, not something that explains the text further as you might assume by giving it as a reference.]}Figure~\ref{fig:tp}B shows contours of $\varrho$ for the $(x,y)$
