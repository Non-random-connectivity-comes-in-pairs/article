...
The simplest non-degenerate distribution of connection probabilities is a distribution that takes two values $x$, $y$ with probability $p$ and $1-p$ respectively. Such a distribution might be highly relevant for cortical networks as a recent study has showed \cc{...what exactly?} \cite{Lee2016}.
