...
network. For more densely connected networks, $\mu>0.1$, the effect
two distinct connection probabilities have on the overrepresentation
of reciprocal connections weakens (c.f. Figure~S1), as one would
intuitively assume from the dependence of the maximal
overrepresentation on $\mu$ in \eqref{eq:rho_max}.


%% the results shown in
%% Figure~\ref{fig:tp}B only change quantitatively
%% (cf.\ Figure~S1.). Reciprocal pair overrepresentation in networks with
%% a higher overall connection probability is
