...
The emerging local networks in the rat visual and somatosensory cortex have been shown to feature non-random structure \cite{Song2005, Perin2011} and much attention was given to bidirectionally connected neuron pairs that are occurring more often than expected from random connectivity \cite{Clopath2010, Miner2016}.
%
